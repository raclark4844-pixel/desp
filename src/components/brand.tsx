  ...
  return (
    <div className="company-branding">
      ...
      <div className="demore-brand">
        <Image src="/demore-technology-solutions-logo.png" alt="Demore Technology Solutions logo" width={1913} height={822} className="demore-logo" priority sizes="(max-width: 600px) 240px, 320px" />
